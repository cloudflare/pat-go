...
type RateLimitedClientV1 struct {
	curve     elliptic.Curve
	secretKey *ecdsa.PrivateKey
}

func NewRateLimitedClientV1FromSecret(secret []byte) RateLimitedClientV1 {
	curve := elliptic.P384()
...
func (c RateLimitedClientV1) CreateTokenRequest(challenge, nonce, blindKeyEnc []byte, tokenKeyID []byte, tokenKey *rsa.PublicKey, originName string, nameKey EncapKey) (RateLimitedTokenRequestState, error) {
...
type RateLimitedIssuerV1 struct {
	curve           elliptic.Curve
...
func NewRateLimitedIssuerV1(key *rsa.PrivateKey) *RateLimitedIssuerV1 {
...
func (i *RateLimitedIssuerV1) NameKey() EncapKey {
	return i.nameKey.Public()
}

func (i *RateLimitedIssuerV1) AddOrigin(origin string) error {
...
func (i *RateLimitedIssuerV1) AddOriginWithIndexKey(origin string, privateKey *ecdsa.PrivateKey) error {
	i.originIndexKeys[origin] = privateKey
	return nil
}

func (i *RateLimitedIssuerV1) OriginIndexKey(origin string) *ecdsa.PrivateKey {
...
func (i *RateLimitedIssuerV1) TokenKey() *rsa.PublicKey {
	return &i.tokenKey.PublicKey
}

func (i *RateLimitedIssuerV1) TokenKeyID() []byte {
...
func (i RateLimitedIssuerV1) Evaluate(req *RateLimitedTokenRequest) ([]byte, []byte, error) {
...
type RateLimitedAttesterV1 struct {
...
func NewRateLimitedAttesterV1(cache ClientStateCache) *RateLimitedAttesterV1 {
	return &RateLimitedAttesterV1{
		cache: cache,
	}
}

func (a *RateLimitedAttesterV1) innerVerifyRequest(tokenRequest RateLimitedTokenRequest) error {
	// Deserialize the request key
	curve := elliptic.P384()
...
func (a *RateLimitedAttesterV1) VerifyRequest(tokenRequest RateLimitedTokenRequest, blindKey *ecdsa.PrivateKey, clientKey *ecdsa.PublicKey, anonymousOrigin []byte) error {
...
func (a *RateLimitedAttesterV1) FinalizeIndex(clientKey, blindEnc, blindedRequestKeyEnc, anonOriginId []byte) ([]byte, error) {
	curve := elliptic.P384()
