...
// https://github.com/ietf-wg-privacypass/ietf-draft-privacypass-batched-tokens/pull/13/files
func (c BatchedClient) CreateTokenRequest(tokenType uint16, tokenRequests []tokens.TokenRequest) (*BatchedTokenRequest, error) {
